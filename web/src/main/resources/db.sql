...
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (1, 'AUD', 'Australian Dollar','AUS');
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (2, 'GBP', 'British Pound', 'GBR');
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (3, 'EUR', 'Euro', 'DEU');
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (4, 'JPY', 'Japanese Yen','JPN');
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (5, 'HUF', 'Hungarian Forint','HUN');
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (6, 'NZD', 'New Zealand Dollar','NZL');
INSERT INTO CURRENCIES (CURRENCY_ID, CURRENCY_CODE, CURRENCY_NAME, COUNTRY_CODE) VALUES (7, 'USD', 'US Dollar', 'USA');

INSERT INTO ROLES (ROLE_ID, ROLE_NAME) VALUES (1, 'ROLE_USER');

INSERT INTO SETTINGS (NAME, VAL) VALUES ('CURRENCY_SERVICE_URL', 'http://apilayer.net/api/currency?access_key=%s&from=%s&to=%s&amount=%s&date=%s');
INSERT INTO SETTINGS (NAME, VAL) VALUES ('HISTORY_SHOW_LAST', '10');
INSERT INTO SETTINGS (NAME, VAL) VALUES ('CONNECTION_TIMEOUT', '10');
INSERT INTO SETTINGS (NAME, VAL) VALUES ('ACCESS_KEY', '');
